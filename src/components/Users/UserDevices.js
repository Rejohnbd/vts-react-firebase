...
import {
  Paper, Card, CardHeader, Divider, CardContent, List, ListItem, 
  ListItemAvatar, Avatar, ListItemText, Typography, ListItemSecondaryAction, 
  IconButton, Grid, TextField, Fab } from '@material-ui/core';
                ...
                />
                 ...
                 <div className={classes.searchGrid}>
                    <Grid container spacing={1} alignItems="flex-end">
                      ...
                      <Grid item>
                        <TextField  id="input-with-icon-grid" label="Search Your Vehicle" InputProps={{ disableUnderline: true}} />
                      </Grid>
                    </Grid>
                  </div>
                   ...
                   <List>
                    <Divider />
                     <ListItem alighItems="flex-start">
                        <ListItemAvatar>
                          <Avatar className={classes.bigAvatar} alt="Driver Profile" src={DriverPic} />
                        </ListItemAvatar>
                        <ListItemText 
                          primary="Rejohn"
                          secondary={
                      ...
                      <ListItemSecondaryAction>
                        <div>
                          ...
                          <Link to={ROUTES.USERVEHICLEDETAIL}>
...
export default connect(mapStateToProps,mapDispatchToProps)(withAuthorization (condition) (withStyles(styles)(UserDevices)));
