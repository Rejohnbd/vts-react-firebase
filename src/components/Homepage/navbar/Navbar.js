        ...
        return (
            <Fragment>
                ...
                <header className="header-area" id="header-area">
                    <div className={`dope-nav-container ${this.state.resNav} dope-sticky`}>
                        <div className="container">
                            <div className="row">
                                <nav className="dope-navbar justify-content-between" id="dopeNav">
                                    ...
                                    <div className="dope-navbar-toggler" onClick={this.menuOnHandler}>
                                        <span className={`navbarToggler ${this.state.menuOnItem ? ('active'): ('')}`}>
                                            <span></span>
                                            <span></span>
                                            <span></span>
                                        </span>
                                    </div>
                                    <div className={`dope-menu ${this.state.menuOnItem ? ('menu-on'): ('')}`}>
                                        <div className="dopecloseIcon" onClick={this.menuCloseHandler}>
